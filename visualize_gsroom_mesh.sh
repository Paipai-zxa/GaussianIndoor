...
do
    ...
    /data1/wxb/indoor/GaussianIndoor/gsroom_results/sdf_output/neus/scene${scene}/scene${scene}-full/meshes/00015000_reso512_scene${scene}_world_clean_bbox_faces.ply \
