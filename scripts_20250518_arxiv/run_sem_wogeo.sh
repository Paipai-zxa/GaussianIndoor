...
base_exp_name=train_sem_wogeo_semantic_guidance_start8000_omega0.000002_final
# base_exp_name=debug_sem_wogeo_semantic_guidance_instancetrain

# 遍历每个weight的所有组合
exp_name="${base_exp_name}_${current_time}"
<<<<<<< HEAD:scripts_20250518_arxiv/run_sem_wogeo.sh
# exp_name="train_sem_wogeo_semantic_guidance_start12000_omega0.000002_final_20250512_154751"
=======
exp_name="train_sem_wogeo_semantic_guidance_start12000_omega0.000002_final_20250512_154740"
>>>>>>> f3b4367b1af5aac9177357d49c7c10f12fafc5e6:run_sem_wogeo.sh
