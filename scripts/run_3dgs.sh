...
# exp_name=train_depth_1.0_0.01_planecons_7000_0.015_scaleflatten_0_10000_rendergeo_1.0_detachall
exp_name=3dgs_depth_10000_1000_woshsinit

data_path=data/${scene}
exp_name=${exp_name}_${current_time}
# exp_name=train_planecons_7000_0.015_scaleflatten_0_10000_rendergeo_1.0_detachall_20250425_123528
