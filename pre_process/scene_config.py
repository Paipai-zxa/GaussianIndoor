...
def get_scene_config(dataset, scene, dataset_root_path="./data"):
    """
    ...
    if dataset == 'scannet':
        config["image_path"] = os.path.join(dataset_root_path, f"{scene}/images")
        config["save_path"] = os.path.join(dataset_root_path, f"{scene}")
        ...
        # 1ada7a0617
            ...
            config["class_name"] = config["text_prompt"].split('.')
            config["class_label"] = [1,2,2,3,3,4,4,5,6,6,6,7,7,8,8,9,10,10,11,11,12,13,13,13,13,13,13,13,13,13,13,13,13]
        ...
        # f6659a3107
            ...
            config["class_name"] = config["text_prompt"].split('.')
            config["class_label"] = [1,2,2,3,3,4,4,5,6,6,7,7,8,9,10,10,10,10,10,10]
