...
if __name__ == '__main__':
    ...
    parser.add_argument('--dir_dataset', type=str, default='/data1/zxa/GaussianIndoor/data')
    parser.add_argument('--dir_results_baseline', type=str, default='/data1/zxa/GaussianIndoor/output')
    parser.add_argument('--path_mesh_pred', type=str, default='/data1/zxa/GaussianIndoor/output/0085_00/fuse_unbounded.ply')
    parser.add_argument('--scene_name', type=str, default='0085_00')
    ...
    if args.mode == 'eval_3D_mesh_metrics':
        ...
        path_intrin = f'{dir_dataset}/color_intrinsics.txt'
        name_baseline = 'gaussian' # manhattansdf neuris
        ...
        path_log = f'{dir_results_baseline}/mesh_results.json'
        mesh_results = {
            'Accuracy': metrics_eval[0],
            'Completion': metrics_eval[1],
            'Precision': metrics_eval[2],
            'Recall': metrics_eval[3],
            'F-score': metrics_eval[4]
        }
        msg = ("scene_name: {} \n \
                path_mesh_pred: {} \n \
                dir_dataset: {} \n \
                mesh_results: {}"
               .format(scene_name, path_mesh_pred, dir_dataset, mesh_results)
            )
        print(msg)
        with open(path_log, 'w') as f:
            json.dump(mesh_results, f, indent=4)
