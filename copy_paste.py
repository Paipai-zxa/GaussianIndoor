...
# 定义目录和输出文件
base_dir = 'output/scannetv2/0085_00/crossview_7000_1.5_numneighbors1_depth_100000_1000_geo_mlp'
...
for folder in sorted(os.listdir(base_dir)):
    ...
    if os.path.isdir(folder_path):
        ...
        with open(output_file, 'a') as f:
            f.write(f"{folder}\t{ssim}\t{psnr}\t{lpips}\t{accuracy}\t{completion}\t{precision}\t{recall}\t{f_score}\n")
